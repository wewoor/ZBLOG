...
<meta http-equiv="keywords" content="Ziv,Ziv小威,Java博客系统">
<meta http-equiv="description" content="Ziv小威的私人博客,开源的Java博客系统">
<link href="${rc.contextPath}/images/head_pic.png" type="image/png" rel="icon"></link>
<link href="${rc.contextPath}/stylesheet/front-style.css" rel="stylesheet" type="text/css" />
